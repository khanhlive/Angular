...
export const Menus: MenuItem[] = [
    ...
    {id:1, name: 'Tài khoản', title: 'Quản lý tài khoản', childs: [], icon: 'fa fa-users', hasChild: false, routerLink: 'accounts' },
    {
        id:2,name: 'Khách hàng', title: 'Quản lý khách hàng', childs: [{
    ...
    {id:3, name: 'Tin tức', title: 'Quản lý tin tức', childs: [], icon: 'fa fa-newspaper-o', hasChild: false, routerLink: 'news' }
]
